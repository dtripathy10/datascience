...
*##############################################################################################################
Parameter
FarmSize(DistrictSelected,FarmNumber) The farm size for the scenario in hectares
FarmLocalCSPDistance(DistrictSelected,FarmNumber,LocalCSPCenterSet)
FarmRegionalCSPDistance(DistrictSelected,FarmNumber,RegionalCSPCenterSet)
FarmLocalMarketDistance(DistrictSelected,FarmNumber,LocalMarketSet)
FarmRegionalMarketDistance(DistrictSelected,FarmNumber,RegionalMarketSet)
...
LocalMarketRGYDistance
RegionalMarketRGYDistance
RegionalMarketFCIDistance
RGYMillerDistance
RGYRetailerDistance
FCIMillerDistance
FCIRetailerDistance
FCIPDSDistance
MillerRetailerDistance
...
GrainProduction(DistrictSelected,FarmNumber) The total grain production in kg for each farm as a function of the total area and average yield
GrainAvailable(DistrictSelected,FarmNumber) The total grain availability in kg on each farm
*
...
*
FarmSize(DistrictSelected,TotalFarmNumber) = FarmSize_Input(TotalFarmNumber,'FarmArea');
GrainProduction(DistrictSelected,TotalFarmNumber) = FarmSize(DistrictSelected,TotalFarmNumber)*normal(AverageGrainYield,GrainYieldStandardDev);

Scalar i;

loop(DistrictSelected,
loop(FarmNumber,
if(FarmSize(DistrictSelected,FarmNumber)<1,
GrainAvailable(DistrictSelected,FarmNumber) =  GrainProduction(DistrictSelected,FarmNumber)*FarmGrainFractionForSale('Marginal')
)
if(FarmSize(DistrictSelected,FarmNumber)>=1 and FarmSize(DistrictSelected,FarmNumber)<2,
GrainAvailable(DistrictSelected,FarmNumber) =  GrainProduction(DistrictSelected,FarmNumber)*FarmGrainFractionForSale('Small')
)
if(FarmSize(DistrictSelected,FarmNumber)>=2 and FarmSize(DistrictSelected,FarmNumber)<4,
GrainAvailable(DistrictSelected,FarmNumber) =  GrainProduction(DistrictSelected,FarmNumber)*FarmGrainFractionForSale('Semi_Medium')
)
if(FarmSize(DistrictSelected,FarmNumber)>=4 and FarmSize(DistrictSelected,FarmNumber)<10,
GrainAvailable(DistrictSelected,FarmNumber) =  GrainProduction(DistrictSelected,FarmNumber)*FarmGrainFractionForSale('Medium')
)
if(FarmSize(DistrictSelected,FarmNumber)>=10,
GrainAvailable(DistrictSelected,FarmNumber) =  GrainProduction(DistrictSelected,FarmNumber)*FarmGrainFractionForSale('Large')
)
));
...
FarmLocalCSPDistance(DistrictSelected,FarmNumber,LocalCSPCenterSet)=normal(25,5);
FarmRegionalCSPDistance(DistrictSelected,FarmNumber,RegionalCSPCenterSet)=normal(40,8);
FarmLocalMarketDistance(DistrictSelected,FarmNumber,LocalMarketSet)=normal(30,5);
FarmRegionalMarketDistance(DistrictSelected,FarmNumber,RegionalMarketSet)$(connectselected(DistrictSelected,RegionalMarketSet))=normal(50,8);
...
FarmLocalCSPDrivingTime(DistrictSelected,FarmNumber,LocalCSPCenterSet,TransportationTypes) =
FarmLocalCSPDistance(DistrictSelected,FarmNumber,LocalCSPCenterSet)/TransportationData('SpeedLoaded',TransportationTypes)
+
FarmLocalCSPDistance(DistrictSelected,FarmNumber,LocalCSPCenterSet)/TransportationData('SpeedEmpty',TransportationTypes);

FarmRegionalCSPDrivingTime(DistrictSelected,FarmNumber,RegionalCSPCenterSet,TransportationTypes) =
FarmRegionalCSPDistance(DistrictSelected,FarmNumber,RegionalCSPCenterSet)/TransportationData('SpeedLoaded',TransportationTypes)
+
FarmRegionalCSPDistance(DistrictSelected,FarmNumber,RegionalCSPCenterSet)/TransportationData('SpeedEmpty',TransportationTypes);

FarmLocalMarketDrivingTime(DistrictSelected,FarmNumber,LocalMarketSet,TransportationTypes) =
FarmLocalMarketDistance(DistrictSelected,FarmNumber,LocalMarketSet)/TransportationData('SpeedLoaded',TransportationTypes)
+
FarmLocalMarketDistance(DistrictSelected,FarmNumber,LocalMarketSet)/TransportationData('SpeedEmpty',TransportationTypes);

FarmRegionalMarketDrivingTime(DistrictSelected,FarmNumber,RegionalMarketSet,TransportationTypes)$(connectselected(DistrictSelected,RegionalMarketSet)) =
FarmRegionalMarketDistance(DistrictSelected,FarmNumber,RegionalMarketSet)/TransportationData('SpeedLoaded',TransportationTypes)
+
FarmRegionalMarketDistance(DistrictSelected,FarmNumber,RegionalMarketSet)/TransportationData('SpeedEmpty',TransportationTypes);
...
FarmLocalCSPDrivingTime(DistrictSelected,FarmNumber,LocalCSPCenterSet,TransportationTypes) + TruckIdlingTimePerTrip(TransportationTypes);

FarmRegionalCSPTransportationTime(DistrictSelected,FarmNumber,RegionalCSPCenterSet,TransportationTypes) =
FarmRegionalCSPDrivingTime(DistrictSelected,FarmNumber,RegionalCSPCenterSet,TransportationTypes) + TruckIdlingTimePerTrip(TransportationTypes);

FarmLocalMarketTransportationTime(DistrictSelected,FarmNumber,LocalMarketSet,TransportationTypes) =
FarmLocalMarketDrivingTime(DistrictSelected,FarmNumber,LocalMarketSet,TransportationTypes)+ TruckIdlingTimePerTrip(TransportationTypes);

FarmRegionalMarketTransportationTime(DistrictSelected,FarmNumber,RegionalMarketSet,TransportationTypes)$(connectselected(DistrictSelected,RegionalMarketSet)) =
FarmRegionalMarketDrivingTime(DistrictSelected,FarmNumber,RegionalMarketSet,TransportationTypes) + TruckIdlingTimePerTrip(TransportationTypes);
...
FarmGatePurchaseDemand(HarvestingHorizonAggregation,DistrictSelected,FarmNumber)= 100;
FarmGatePurchaseDemand_UpperBound(HarvestingHorizonAggregation,DistrictSelected,FarmNumber)= 10000;
FarmGatePurchaseDemand_LowerBound(HarvestingHorizonAggregation,DistrictSelected,FarmNumber)= 0;
FarmGatePurchaseDemand(NonHarvestingHorizonAggregation,DistrictSelected,FarmNumber)= 100;
FarmGatePurchaseDemand_UpperBound(NonHarvestingHorizonAggregation,DistrictSelected,FarmNumber)= 10000;
FarmGatePurchaseDemand_LowerBound(NonHarvestingHorizonAggregation,DistrictSelected,FarmNumber)= 0;
