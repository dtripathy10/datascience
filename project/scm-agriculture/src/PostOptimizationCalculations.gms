...
TotalBags =                     sum((HarvestingHorizonAggregation,DistrictSelected,FarmNumber,LocalCSPCenterSet),
...
Farm_GrainSalePattern(DistrictSelected,FarmNumber,'Production') = GrainAvailable(DistrictSelected,FarmNumber);


Farm_GrainSalePatternFraction(DistrictSelected,FarmNumber,GrainMarkets) = Farm_GrainSalePattern(DistrictSelected,FarmNumber,GrainMarkets)/Farm_GrainSalePattern(DistrictSelected,FarmNumber,'Production');
