...
MillerConstraint2(HarvestingHorizonAggregation,MillerSet)..   
  MillerInput(HarvestingHorizonAggregation,MillerSet) =l= MillerProcessingCapacity(MillerSet);
...
MillerConstraint4(NonHarvestingHorizonAggregation,MillerSet)..   
  MillerInput(NonHarvestingHorizonAggregation,MillerSet) =l= MillerProcessingCapacity(MillerSet);

MillerConstraint5(MillerSet).. 
  MillerProcessingCapacity(MillerSet)=l=MillerProcessingCapacity_Max(MillerSet);

MillerConstraint6(MillerSet).. 
  MillerProcessingCapacity(MillerSet)=g=MillerProcessingCapacity_Min(MillerSet);
...
MillerConstraint18(MillerSet)..   
  MillerStorageCapacity(MillerSet) =l= MillerStorageCapacity_Max(MillerSet);
...
MillerConstraint19(MillerSet)..    
  MillerSelector(MillerSet) =g= MillerProcessingCapacity(MillerSet)/MillerProcessingCapacity_Max(MillerSet);
