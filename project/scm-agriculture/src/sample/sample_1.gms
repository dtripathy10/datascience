...
waste_1(machine) .. sum(product, product_unit(product)*constraint(machine,product)) =e= waste(machine) ;

resource_constraint(machine) .. waste(machine) =l= machine_availability(machine) ;
...
Display waste.l, tottal_profit.l;
