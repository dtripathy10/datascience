...
*                 TransportationConstraint19
*                 TransportationConstraint20
*                 TransportationConstraint21
*                 TransportationConstraint22
*                 TransportationConstraint23
*                 TransportationConstraint24
*                 TransportationConstraint25
*                 TransportationConstraint26
*                 TransportationConstraint27
...
*                 TransportationConstraint19A
*                 TransportationConstraint20A
*                 TransportationConstraint21A
*                 TransportationConstraint22A
*                 TransportationConstraint23A
*                 TransportationConstraint24A
*                 TransportationConstraint25A
*                 TransportationConstraint26A
*                 TransportationConstraint27A
                 ;
...
*=================================================================================================================================================================
TransportationConstraint1(HarvestingHorizonAggregation,FarmNumber,LocalCSPCenterSet,TransportationTypes)..
                 ...
                 FarmLocalCSPTransportationTime(FarmNumber,LocalCSPCenterSet,TransportationTypes)/HoursPerDay;

TransportationConstraint2(HarvestingHorizonAggregation,FarmNumber,RegionalCSPCenterSet,TransportationTypes)..
                 FarmRegionalCSPTruckRequirement(HarvestingHorizonAggregation,FarmNumber,RegionalCSPCenterSet,TransportationTypes)
                 =g=
                 FarmRegionalCSPTruckTripRequirement(HarvestingHorizonAggregation,FarmNumber,RegionalCSPCenterSet,TransportationTypes)*
                 FarmRegionalCSPTransportationTime(FarmNumber,RegionalCSPCenterSet,TransportationTypes)/HoursPerDay;

TransportationConstraint3(HarvestingHorizonAggregation,FarmNumber,LocalMarketSet,TransportationTypes)..
                 FarmLocalMarketTruckRequirement(HarvestingHorizonAggregation,FarmNumber,LocalMarketSet,TransportationTypes)
                 =g=
                 FarmLocalMarketTruckTripRequirement(HarvestingHorizonAggregation,FarmNumber,LocalMarketSet,TransportationTypes)*
                 FarmLocalMarketTransportationTime(FarmNumber,LocalMarketSet,TransportationTypes)/HoursPerDay;

TransportationConstraint4(HarvestingHorizonAggregation,FarmNumber,RegionalMarketSet,TransportationTypes)..
                 FarmRegionalMarketTruckRequirement(HarvestingHorizonAggregation,FarmNumber,RegionalMarketSet,TransportationTypes)
                 =g=
                 FarmRegionalMarketTruckTripRequirement(HarvestingHorizonAggregation,FarmNumber,RegionalMarketSet,TransportationTypes)*
                 FarmRegionalMarketTransportationTime(FarmNumber,RegionalMarketSet,TransportationTypes)/HoursPerDay;
...
TransportationConstraint17(HarvestingHorizonAggregation,MillerSet,RetailerSet,TransportationTypes)
...
TransportationConstraint18(HarvestingHorizonAggregation,TransportationTypes)..
                                 sum((FarmNumber,LocalCSPCenterSet),
                                         FarmLocalCSPTruckRequirement(HarvestingHorizonAggregation,FarmNumber,LocalCSPCenterSet,TransportationTypes)
                                 )
                                 +
                                 sum((FarmNumber,RegionalCSPCenterSet),
                                         FarmRegionalCSPTruckRequirement(HarvestingHorizonAggregation,FarmNumber,RegionalCSPCenterSet,TransportationTypes)
                                 )
                                 +
                                 sum((FarmNumber,LocalMarketSet),
                                         FarmLocalMarketTruckRequirement(HarvestingHorizonAggregation,FarmNumber,LocalMarketSet,TransportationTypes)
                                 )
                                 +
                                 sum((FarmNumber,RegionalMarketSet),
                                         FarmRegionalMarketTruckRequirement(HarvestingHorizonAggregation,FarmNumber,RegionalMarketSet,TransportationTypes)
                                 )
                                 +
...
* locations and the total number of hours per day available are used to do this calculation.
*=================================================================================================================================================================
TransportationConstraint1A(NonHarvestingHorizonAggregation,FarmNumber,LocalCSPCenterSet,TransportationTypes)..
...
TransportationConstraint2A(NonHarvestingHorizonAggregation,FarmNumber,RegionalCSPCenterSet,TransportationTypes)..
                 FarmRegionalCSPTruckRequirement(NonHarvestingHorizonAggregation,FarmNumber,RegionalCSPCenterSet,TransportationTypes)
                 =g=
                 FarmRegionalCSPTruckTripRequirement(NonHarvestingHorizonAggregation,FarmNumber,RegionalCSPCenterSet,TransportationTypes)*
                 FarmRegionalCSPTransportationTime(FarmNumber,RegionalCSPCenterSet,TransportationTypes)/HoursPerDay;

TransportationConstraint3A(NonHarvestingHorizonAggregation,FarmNumber,LocalMarketSet,TransportationTypes)..
                 FarmLocalMarketTruckRequirement(NonHarvestingHorizonAggregation,FarmNumber,LocalMarketSet,TransportationTypes)
                 =g=
                 FarmLocalMarketTruckTripRequirement(NonHarvestingHorizonAggregation,FarmNumber,LocalMarketSet,TransportationTypes)*
                 FarmLocalMarketTransportationTime(FarmNumber,LocalMarketSet,TransportationTypes)/HoursPerDay;

TransportationConstraint4A(NonHarvestingHorizonAggregation,FarmNumber,RegionalMarketSet,TransportationTypes)..
                 FarmRegionalMarketTruckRequirement(NonHarvestingHorizonAggregation,FarmNumber,RegionalMarketSet,TransportationTypes)
                 =g=
...
TransportationConstraint17A(NonHarvestingHorizonAggregation,MillerSet,RetailerSet,TransportationTypes)
                 $(TransportationData('LongDistanceIndicator',TransportationTypes))..
