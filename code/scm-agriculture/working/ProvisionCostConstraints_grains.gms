...
ProvisionCostConstraint4..
  RegionalCSPStorageOperatingCost
  =g=
...
*
ProvisionCostConstraint6..
  RGYRentalCost =e= sum((HarvestingHorizonAggregation,RGYSet), (RGYStoredGrain(HarvestingHorizonAggregation,RGYSet)/50)
...
ProvisionCostConstraint8..
  TotalStorageCost =e= LocalCSPCapitalCost + RegionalCSPCapitalCost + LocalCSPStorageOperatingCost + RegionalCSPStorageOperatingCost + RGYCapitalCost + RGYRentalCost;
...
ProvisionCostConstraint13(MillerSet)..
  MillerOperatingCost(MillerSet) =e=
...
ProvisionCostConstraint16(FCIGodownSet)..
  FCIStorageCost(FCIGodownSet)
  =e=
