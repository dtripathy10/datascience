...
FCIBalance19(FCIGodownSet)..    FCICAPCapacity(FCIGodownSet) + FCICoveredCapacity(FCIGodownSet) =l= FCI_Max(FCIGodownSet);

FCIBalance20(FCIGodownSet)..    FCISelector(FCIGodownSet) =g= (FCICAPCapacity(FCIGodownSet) + FCICoveredCapacity(FCIGodownSet))/FCI_Max(FCIGodownSet);

FCIBalance21(FCIGodownSet)..    FCICAPCapacity(FCIGodownSet) + FCICoveredCapacity(FCIGodownSet) =g= FCISelector(FCIGodownSet)*FCI_Min(FCIGodownSet);


FCIBalance22.. sum((HarvestingHorizonAggregation,FCIGodownSet), FCICAPStorageInput(HarvestingHorizonAggregation,FCIGodownSet))
