...
Variable GrainProvisionObjective The second phase objective function
...
Positive variables
                 ...
                 RGYInput The total input to a particular RGY during a given time-step
...
$ontext
* Internal variables for problem solution
Positive variables
                         CentrallyStoredBiomass(SimulationHorizon,CountyDataSet,TotalFarmNumber,CentralizedStorageLocationSet,HarvestingHorizon) Biomass stored in each centralized storage location
                         CentrallyStoredSmallScaleBiomass(SimulationHorizon,CountyDataSet,TotalFarmNumber,CentralizedStorageSmallScaleLocationSet,HarvestingHorizon) Biomass stored in each small scale centralized storage location
                         CentrallyStoredBiomassVolume The total volume of biomass stored in central storage facility
                         CentrallyStoredSmallScaleBiomassVolume The total volume of biomass stored in small scale storage facility
                         HarvestingEndCentralBiomassStorage Biomass stored in the central storage faciltu at the end of the harvesting horizon;

Positive variables
                         CentralStorageProcessingInput The total biomass that is sent to centralized storage processing
                         CentralStorageSmallScaleProcessingInput The total biomass that is sent to small scale storage processing
                         CentralStorageProcessingOutput The total biomass output from the centralized storage processing
                         CentralStorageSmallScaleProcessingOutput The total biomass output from the small scale storage processing
                         CentralStorageProcessingOutputVolume The total volume of biomass output from the centralized storage processing
                         CentralStorageSmallScaleProcessingOutputVolume The total volume of biomass output from the small scale storage processing
                         CentralStorageProcessingOperatingCost The operating cost associated with the processing of biomass at the centralized storage
                         CentralStorageSmallScaleProcessingOperatingCost The operating cost associated with the processing of biomass at the small scale centralized storage
                         CentralStorageProcessingCapitalCost The capital cost associated with the processing of biomass at the centralized storage
                         CentralStorageSmallScaleProcessingCapitalCost The capital cost associated with the processing of biomass at the small scale centralized storage

                         CentralStorageProcessedBiomass The total processed biomass at the central storage facility at any time when biomass processing is done at the input of the storage
                         CentralStorageOutputToRefineryProcessed The biomass output from the centralized storage faciliy when when biomass processing is done at the input of the storage
                         CentralStorageOutputToRegionalProcessed
                         CentralStorageSmallScaleOutputProcessed The biomass output from the small scale centralized storage faciliy when when biomass processing is done at the input of the storage

Integer variables
                         NumberOfCentralStorageProcessors Number of machines to be used at the centralized storage facility for processing of biomass using the selected option;
                         NumberOfCentralStorageSmallScaleProcessors

*=======================================================================================
* Declaration of the bounds (if any) on the variables declared above
*=======================================================================================
NumberOfCentralStorageProcessors.up(CentralizedStorageLocations) = 50000;
...
*Binary variable
*                         TransportationTypeSelector(TotalFarmNumber,TransportationTypes) The binary variable that indicates whether a particular transportation truck has been selected biomass transportation from a farm
*                         TransportationTypeSelector2(CentralizedStorageLocationSet,TransportationTypes) The binary variable that indicates whether a particular transportation truck has been selected biomass transportation between the given centralized storage facility and the refinery;
