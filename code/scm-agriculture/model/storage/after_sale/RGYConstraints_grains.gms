...
RGYBalance10(RGYSet)..    RGYCapacity(RGYSet) =l= RGY_Max;

RGYBalance11(RGYSet)..    RGYSelector(RGYSet) =g= RGYCapacity(RGYSet)/RGY_Max;

RGYBalance12(RGYSet)..    RGYCapacity(RGYSet) =g= RGYSelector(RGYSet)*RGY_Min;
