...
MillerConstraint1(HarvestingHorizonAggregation,MillerSet)..
                         ...
                         +
                         sum(FCIGodownSet,FCICoveredMillerGrain(HarvestingHorizonAggregation,FCIGodownSet,MillerSet))
                         +
                         sum(RGYSet,RGYMillerGrain(HarvestingHorizonAggregation,RGYSet,MillerSet));

MillerConstraint2(HarvestingHorizonAggregation,MillerSet)..   MillerInput(HarvestingHorizonAggregation,MillerSet) =l= MillerProcessingCapacity(MillerSet);

MillerConstraint3(NonHarvestingHorizonAggregation,MillerSet)..
                         MillerInput(NonHarvestingHorizonAggregation,MillerSet) =e=
                         sum(FCIGodownSet,FCICAPMillerGrain(NonHarvestingHorizonAggregation,FCIGodownSet,MillerSet))
                         +
                         sum(FCIGodownSet,FCICoveredMillerGrain(NonHarvestingHorizonAggregation,FCIGodownSet,MillerSet))
                         +
                         sum(RGYSet,RGYMillerGrain(NonHarvestingHorizonAggregation,RGYSet,MillerSet));

MillerConstraint4(NonHarvestingHorizonAggregation,MillerSet)..   MillerInput(NonHarvestingHorizonAggregation,MillerSet) =l= MillerProcessingCapacity(MillerSet);

MillerConstraint5(MillerSet).. MillerProcessingCapacity(MillerSet)=l=MillerProcessingCapacity_Max(MillerSet);
MillerConstraint6(MillerSet).. MillerProcessingCapacity(MillerSet)=g=MillerProcessingCapacity_Min(MillerSet);

*===========================================================================================================
* Mass balance constraints for the harvesting horizon
*===========================================================================================================
MillerConstraint7(HarvestingHorizonAggregation,MillerSet)..   MilledGrainOutput(HarvestingHorizonAggregation,MillerSet) =e=
...
MillerConstraint10(HarvestingHorizonAggregation,MillerSet)..
                         ...
                         =e=
                         sum(RetailerSet, MillerRetailerGrain(HarvestingHorizonAggregation,MillerSet,RetailerSet));
*===========================================================================================================
* Mass balance constraints for the non-harvesting horizon
*===========================================================================================================
MillerConstraint11(NonHarvestingHorizonAggregation,MillerSet)..   MilledGrainOutput(NonHarvestingHorizonAggregation,MillerSet) =e=
...
MillerConstraint15(NonHarvestingHorizonAggregation,MillerSet)..
                         ...
                         =e=
                         sum(RetailerSet, MillerRetailerGrain(NonHarvestingHorizonAggregation,MillerSet,RetailerSet));


*===========================================================================================================
* Constraints on the total storage capacity of the miller
*===========================================================================================================
...
MillerConstraint18(MillerSet)..   MillerStorageCapacity(MillerSet) =l= MillerStorageCapacity_Max(MillerSet);

*===========================================================================================================
* Constraints related to the binary selection variable for the selection of a particular miller
*===========================================================================================================
MillerConstraint19(MillerSet)..    MillerSelector(MillerSet) =g= MillerProcessingCapacity(MillerSet)/MillerProcessingCapacity_Max(MillerSet);
